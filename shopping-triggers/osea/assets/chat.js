  ...
  function addEmailCapture() {
    ...
    wrap.innerHTML = `
      <label class="email-capture__consent">
        ...
        <span>By checking this box, you agree to receive communications from Osea.</span>
      </label>
    ...
    form.addEventListener('submit', e => {
      ...
      addTypingThen(() => {
        addAgentMsg(marketing
          ? `Done. Your routine and layering guide are on the way to ${email}. We'll also keep you posted on new drops.`
