...
(function () {
  ...
  // Email capture shown after results — floats in the conversation, footer hidden
  function addEmailCapture() {
    addAgentMsg("Your results are ready. To get your fit recommendations sent to you, enter your email below.");
    ...
    wrap.innerHTML = `
      <label class="email-capture__consent">
        ...
        <span>By checking this box, you agree to receive communications from Archies.</span>
      </label>
    ...
    form.addEventListener('submit', e => {
      ...
      addTypingThen(() => {
        addAgentMsg(marketing
          ? `Done. Your picks are on the way to ${email}. We'll also keep you posted on new drops.`
          : `Done. Your picks are on the way to ${email}.`);
