...
(function () {
  ...
  function addEmailCapture() {
    addAgentMsg("Your results are ready. To get your full recommendations sent to you, enter your email below.");
    ...
    wrap.innerHTML = `
      <label class="email-capture__consent">
        ...
        <span>By checking this box, you agree to receive communications from Koh.</span>
      </label>
    ...
    form.addEventListener('submit', e => {
      ...
      addTypingThen(() => {
        addAgentMsg(marketing
          ? `Done. Your recommendations are on the way to ${email}. We'll also keep you posted on new launches.`
          : `Done. Your recommendations are on the way to ${email}.`);
